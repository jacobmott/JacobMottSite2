...
import 'jquery';
import '../../assets/scrollHorizontally/fullpage.scrollHorizontally.min.js';
import 'fullpage.js/dist/fullpage.extensions.min'
declare var $: any;


@Component({
  selector: 'app-jacobmott',
  templateUrl: './jacobmott.component.html',
  styleUrls: ['./jacobmott.component.scss']
})
export class JacobmottComponent implements AfterViewInit, OnInit{
  config: any;
  fullpage_api: any;
